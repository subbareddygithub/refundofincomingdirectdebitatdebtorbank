...
public class RetrieveOutboundPaymentsResponse   {
  ...
  public RetrieveOutboundPaymentsResponse correspondentBankOperatingSession(InitiateCorrespondentBankOperatingSessionResponseCorrespondentBankOperatingSession correspondentBankOperatingSession) {
  ...
  */
  ...
  public RetrieveOutboundPaymentsResponse outboundPayments(UpdateInboundPaymentsRequestInboundPayments outboundPayments) {
  ...
  */
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RetrieveOutboundPaymentsResponse retrieveOutboundPaymentsResponse = (RetrieveOutboundPaymentsResponse) o;
    return Objects.equals(this.correspondentBankOperatingSession, retrieveOutboundPaymentsResponse.correspondentBankOperatingSession) &&
        Objects.equals(this.outboundPayments, retrieveOutboundPaymentsResponse.outboundPayments);
  }

  @Override
  public int hashCode() {
    return Objects.hash(correspondentBankOperatingSession, outboundPayments);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RetrieveOutboundPaymentsResponse {\n");
