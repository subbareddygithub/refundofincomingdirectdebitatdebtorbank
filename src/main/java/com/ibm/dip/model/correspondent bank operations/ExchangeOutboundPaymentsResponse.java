...
public class ExchangeOutboundPaymentsResponse   {
  @JsonProperty("OutboundPayments")
  private UpdateInboundPaymentsRequestInboundPayments outboundPayments;

  public ExchangeOutboundPaymentsResponse outboundPayments(UpdateInboundPaymentsRequestInboundPayments outboundPayments) {
  ...
  */
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ExchangeOutboundPaymentsResponse exchangeOutboundPaymentsResponse = (ExchangeOutboundPaymentsResponse) o;
    return Objects.equals(this.outboundPayments, exchangeOutboundPaymentsResponse.outboundPayments);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExchangeOutboundPaymentsResponse {\n");
